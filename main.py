    ...
    param_dicts = [
        {
            "params":
                [p for n, p in model_without_ddp.named_parameters()
                 if not match_name_keywords(n, args.lr_backbone_names) and not match_name_keywords(n, args.lr_linear_proj_names) and not match_name_keywords(n, args.lr_fpn_names) and p.requires_grad],
            "lr": args.lr,
        },
        {
        ...
        {
            "params": [p for n, p in model_without_ddp.named_parameters() if
                       match_name_keywords(n, args.lr_fpn_names) and p.requires_grad],
            "lr": args.lr * args.lr_fpn_mult,
        }
    ]
    if args.sgd:
